      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <svg fill="none" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg" className="w-full h-full object-cover">
          ...
          <g>
            ...
            <circle fill="#c7d2fe" r="5">
              <animateMotion dur="8s" path="M 200,150 m 0,-100 a 100,100 0 1,0 0,200 a 100,100 0 1,0 0,-200" repeatCount="indefinite"></animateMotion>
            </circle>
          </g>
          <line stroke="#4f46e5" strokeDasharray="4 4" strokeWidth="2" x1="200" x2="200" y1="125" y2="80">
            <animate attributeName="stroke-dashoffset" dur="1s" repeatCount="indefinite" values="0;8"></animate>
          </line>
          <line stroke="#4f46e5" strokeDasharray="4 4" strokeWidth="2" x1="225" x2="270" y1="150" y2="150">
            <animate attributeName="stroke-dashoffset" dur="1s" repeatCount="indefinite" values="0;-8"></animate>
          </line>
        </svg>
      </div>
      ...
      <main className="w-full max-w-md flex flex-col items-center animate-fade-in-up z-10">
        <header className="flex flex-col items-center text-center mb-10 w-full">
          ...
          <p className="text-body-md font-body-md text-on-surface-variant max-w-xs mx-auto">
            Turn your code and data into professional reports — instantly.
          </p>
        </header>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2 text-left">
              <div className="flex items-center justify-between">
                ...
                <a className="text-label-sm font-label-sm text-primary-container hover:text-primary transition-colors duration-200" href="#">
                  Forgot password?
                </a>
              </div>
              <div className="relative group">
        ...
        <div className="mt-8 text-center">
          <p className="text-body-sm font-body-sm text-on-surface-variant">
            ...
            <Link to="/register" className="text-primary-container hover:text-primary font-medium transition-colors duration-200 ml-1">
              Sign up
            </Link>
          </p>
        </div>
